            ...
            <div className="about-sections">
                <div className="about-left">
                    <div className="about-details">
                        <Image src={bullet_icon} alt="" width={20} height={20} />
                        <p>Grind Buddy uses advanced algorithms to match you with the most compatible <b>study partner</b>. Whether you prefer studying <b>in person with someone nearby or virtually with someone who shares your study habits</b>, Grind Buddy has you covered.</p>
                    </div>
                    <div className="about-details">
                        <Image src={bullet_icon} alt="" width={20} height={20} />
                        <p>Choose between in-person and virtual study sessions. Grind Buddy ensures that you can find the <b>partner</b> regardless of your location or preference.</p>
                    </div>
                    <div className="about-details">
                        <Image src={bullet_icon} alt="" width={20} height={20} />
                        <p>Having a dedicated study partner helps you stay <b>focused and motivated</b>. Grind Buddy ensures that you can make the most out of your study time.</p>
                    </div>
                </div>
                <div className="about-right">
                    <Image src={study} alt="Study Image" />
                </div>
            </div>
